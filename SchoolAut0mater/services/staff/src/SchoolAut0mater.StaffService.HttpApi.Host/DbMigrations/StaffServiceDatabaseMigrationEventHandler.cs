...
public class StaffServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<StaffServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public StaffServiceDatabaseMigrationEventHandler(
