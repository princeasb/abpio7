...
using SchoolAut0mater.StaffService.DbMigrations;
...
[DependsOn(
    ...
    typeof(StaffServiceHttpApiModule),
    typeof(StaffServiceEntityFrameworkCoreModule)
    )]
public class StaffServiceHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        JwtBearerConfigurationHelper.Configure(context, "StaffService");
    ...
    public async override Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        using (var scope = context.ServiceProvider.CreateScope())
        {
            await scope.ServiceProvider
                .GetRequiredService<StaffServiceDatabaseMigrationChecker>()
