...
public class PowerSchoolServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<PowerSchoolServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public PowerSchoolServiceDatabaseMigrationEventHandler(
