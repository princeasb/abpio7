...
public class StoreServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<StoreServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public StoreServiceDatabaseMigrationEventHandler(
