...
using SchoolAut0mater.StoreService.DbMigrations;
...
[DependsOn(
    ...
    typeof(StoreServiceHttpApiModule),
    typeof(StoreServiceEntityFrameworkCoreModule)
    )]
public class StoreServiceHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        JwtBearerConfigurationHelper.Configure(context, "StoreService");
    ...
    public async override Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        using (var scope = context.ServiceProvider.CreateScope())
        {
            await scope.ServiceProvider
                .GetRequiredService<StoreServiceDatabaseMigrationChecker>()
