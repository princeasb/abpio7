...
public class CoreServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<CoreServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public CoreServiceDatabaseMigrationEventHandler(
