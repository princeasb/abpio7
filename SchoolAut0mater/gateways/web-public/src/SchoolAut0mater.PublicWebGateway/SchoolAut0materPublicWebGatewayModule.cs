...
using SchoolAut0mater.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace SchoolAut0mater.PublicWebGateway;

[DependsOn(
    typeof(SchoolAut0materSharedHostingGatewaysModule)
)]
public class SchoolAut0materPublicWebGatewayModule : AbpModule
{
